...
public interface PacienteRepository extends JpaRepository<PacienteModel, Integer> {
    ...
    /**
     * Busca um paciente pelo ID, apenas se ele estiver ativo.
     *
     * @param id ID do paciente.
     * @return Optional contendo o PacienteModel se encontrado e ativo, ou vazio.
     */
    Optional<PacienteModel> findByIdAndAtivoTrue(Integer id);
}
